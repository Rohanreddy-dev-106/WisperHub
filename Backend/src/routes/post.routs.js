...
// Create post - receives JSON { text }
...
PostRoutes.get("/get-all", jwtAuth, (req, res, next) => {
    Post.readAllPosts(req, res, next);
});

PostRoutes.get("/get-single/:postId", jwtAuth, (req, res, next) => {
    Post.readOnePost(req, res, next);
});
